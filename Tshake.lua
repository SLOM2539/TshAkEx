...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1918355976,1619524486}
print([[
...
var = "مطور السورس"
elseif tonumber(user_id) == tonumber(1918355976) then  
var = "مطور السورس"
...
download_to_file('https://raw.githubusercontent.com/SLOM2539/TshAkEx/master/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/SLOM2539/TshAkEx/master/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
...
if DevTshake(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SLOM2539/files_tshake/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SLOM2539/files_tshake/master/files_tshake/"..file)
if res == 200 then
...
Text = [[
🐲┇ Welcome to Source
🚩┇[ Tm   -  ”DeTroit”](t.me/VWDAD)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🐉┇[DeTroit TEAM](t.me/VWDAD)
